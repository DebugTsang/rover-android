 ...
 */
public class EstimoteHelper implements ILocationHelper{
    ...
    EstimoteHelper(Context context, Handler handler){
    ...
    BeaconManager.MonitoringListener monitoringListener = new BeaconManager.MonitoringListener() {
        ...
        public void onEnteredRegion(Region region, List<Beacon> beacons) {
            ...
            if (beacons.size() != 0) {
                ...
                co.roverlabs.sdk.models.Region rangingRegion = new co.roverlabs.sdk.models.Region(beacon.getProximityUUID(), beacon.getMajor(), null);
