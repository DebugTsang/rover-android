...
public class RequestCreator {
   ...
   * By default, all requests have {@link com.squareup.picasso.Picasso.Priority#NORMAL} priority, except for
   * {@link #fetch()} requests, which have {@link com.squareup.picasso.Picasso.Priority#LOW} priority by default.
   */
  ...
  /**
   * @deprecated Use {@link #memoryPolicy(com.squareup.picasso.MemoryPolicy, com.squareup.picasso.MemoryPolicy...)} instead.
   */
  ...
  /**
   * Specifies the {@link com.squareup.picasso.MemoryPolicy} to use for this request. You may specify additional policy
  ...
  /**
   * Specifies the {@link com.squareup.picasso.NetworkPolicy} to use for this request. You may specify additional policy
   * options using the varargs parameter.
   */
  ...
  /**
   * Asynchronously fulfills the request without a {@link android.widget.ImageView} or {@link com.squareup.picasso.Target},
   * and invokes the target {@link com.squareup.picasso.Callback} with the result. This is useful when you want to warm
