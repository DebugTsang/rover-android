 ...
 * ({@link #canHandleRequest(com.squareup.picasso.Request)} and {@link #load(com.squareup.picasso.Request, int)}) with your custom logic to
 * load images.
 * <p>
 * You should then register your {@link com.squareup.picasso.RequestHandler} using
 * {@link com.squareup.picasso.Picasso.Builder#addRequestHandler(com.squareup.picasso.RequestHandler)}
 * <p>
...
public abstract class RequestHandler {
  /**
   * {@link com.squareup.picasso.RequestHandler.Result} represents the result of a {@link #load(com.squareup.picasso.Request, int)} call in a
   * {@link com.squareup.picasso.RequestHandler}.
   *
   * @see com.squareup.picasso.RequestHandler
   * @see #load(com.squareup.picasso.Request, int)
   */
  public static final class Result {
    ...
    /** The loaded {@link android.graphics.Bitmap}. Mutually exclusive with {@link #getStream()}. */
     ...
     * {@link #load(com.squareup.picasso.Request, int)} call.
     */
    ...
    /**
     * Returns the resulting EXIF orientation generated from a {@link #load(com.squareup.picasso.Request, int)} call.
  ...
  /**
   * Whether or not this {@link com.squareup.picasso.RequestHandler} can handle a request with the given {@link com.squareup.picasso.Request}.
   */
   ...
   * @param networkPolicy the {@link com.squareup.picasso.NetworkPolicy} for this request.
   */
