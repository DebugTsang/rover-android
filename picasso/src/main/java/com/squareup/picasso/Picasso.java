...
public class Picasso {
   ...
   *
   * @see com.squareup.picasso.RequestCreator#priority(com.squareup.picasso.Picasso.Priority)
   */
  ...
  /**
   * Cancel any existing requests for the specified {@link android.widget.RemoteViews} target with the given {@code
   * viewId}.
   */
   ...
   * on new requests with {@link com.squareup.picasso.RequestCreator#tag(Object)}.
   *
   * @see com.squareup.picasso.RequestCreator#tag(Object)
   */
   ...
   * placeholder, if one is specified.
   * <p>
   * Equivalent to calling {@link #load(android.net.Uri) load(Uri.fromFile(file))}.
   *
   * @see #load(android.net.Uri)
   * @see #load(String)
   * @see #load(int)
   ...
   * {@linkplain com.squareup.picasso.RequestCreator#stableKey stable key}.
   *
   * @see #invalidate(android.net.Uri)
   * @see #invalidate(java.io.File)
   */
  ...
  public static class Builder {
    ...
    /**
     * Specify the default {@link android.graphics.Bitmap.Config} used when decoding images. This can be overridden
     * on a per-request basis using {@link com.squareup.picasso.RequestCreator#config(android.graphics.Bitmap.Config) config(..)}.
     */
    ...
    /** Register a {@link com.squareup.picasso.RequestHandler}. */
