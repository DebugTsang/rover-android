 ...
 */
public class RecyclerViewOnItemSwipeListener implements RecyclerView.OnItemTouchListener {
    ...
    public RecyclerViewOnItemSwipeListener(RecyclerView recyclerView, SwipeListener listener) {
    ...
    //The callback interface used by {@link RecyclerViewOnItemSwipeListener} to inform its client
